...
/**
 * Ici repose les noms de chaque monnaie, ces noms permettent de
 * manipuler des monnaies specifiques
 */

public interface CurrencyNames {
    final String ABSENCE_NOM = "ABSENCE";
    ...
    final String DARKSOULS_NOM = "DARKSOULS";
    final String DND_NOM = "DND";
    final String FRERE_JUMEAU_NOM = "FREREJUMEAU";
    final String KIRIKOU_NOM = "KIRIKOU";
    final String LINUX_NOM = "LINUX";
    final String MAGIC_NOM = "MAGIC";
